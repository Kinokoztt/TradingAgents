...
class MarketDataTools(Protocol):
    ...
    def get_economic_calendar(self, start_date: str, end_date: str, cutoff: str | None = ...) -> str: ...
    ...
    def load_daily_ohlc(self, tickers: list[str], start_date: str, end_date: str) -> pd.DataFrame: ...
    def load_daily_ohlcv(self, tickers: list[str], start_date: str, end_date: str) -> pd.DataFrame: ...
